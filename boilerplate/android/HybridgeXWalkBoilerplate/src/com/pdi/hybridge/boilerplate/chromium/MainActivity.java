...
package com.pdi.hybridge.boilerplate.chromium;
...
import com.pdi.hybridge.chromium.HybridgeActionListener;
import com.pdi.hybridge.chromium.HybridgeXWalkView;
...
public class MainActivity extends Activity implements HybridgeActionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.load("file:///android_asset/hybridge.html", null);

        // Alternatively you can set the URL of your web app:
        // --> mWebView.load("http://HOST:PORT/hybridge.html", null);
        // As well as load from a manifest file providing fine grained information:
