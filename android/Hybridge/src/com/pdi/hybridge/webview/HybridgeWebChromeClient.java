...
public class HybridgeWebChromeClient extends WebChromeClient {
    ...
    public final boolean onJsPrompt(WebView view, String url, String msg, String defValue,
        ...
        try {
            ...
            final HybridgeBroadcaster hybridgeBroadcaster = HybridgeBroadcaster.getInstance(view);
            if (action.equals(HybridgeConst.ACTION_INIT)) {
                result.confirm(defValue);
                hybridgeBroadcaster.fireJavascriptEvent(view, HybridgeConst.Event.READY, json);
            } else {
                executeJSONTask(action, json, result, hybridgeBroadcaster,
