...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
  ...
  [self.viewController fireEventInWebView: (NSString*) @"HybridgePause" data:(NSString*) [self getTimestampJSON]];
}
...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
  ...
  [self.viewController fireEventInWebView: (NSString*) @"HybridgeResume" data:(NSString*) [self getTimestampJSON]];
}
