...
2. [Installation](#installation)
  2.1. [Javascript](#installation_javascript)
  2.2. [Android](#installation_android)
  2.3 [iOS](#installation_ios)
3. [Usage](#usage)
  3.1. [Javascript](#usage_javascript)
  3.2. [Android](#usage_android)
  3.3. [iOS](#usage_ios)
  3.4 [Boilerplate](#usage_boilerplate)
4. [Native Events](#events)
  4.1. [Android](#events_android)
  4.2. [iOS](#events_ios)
  4.3. [Javascript](#events_javascript)
5. [Javascript API](#api)
  5.1. [Methods](#api_methods)
  5.2. [Properties](#api_properties)
6. [Debug](#debug)
7. [Custom Errors](#errors)
8. [Demos](#demos)
9. [License](#license)
...
You can build your own Hybridge, but you can start with the latest version included at [hybridge.jar](boilerplate/android/HybridgeBoilerplate/libs/hybridge-1.3.4.jar) in the boilerplate code.
